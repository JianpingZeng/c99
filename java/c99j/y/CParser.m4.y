...
// (6.7.9)
rule(<InitAst.Initializer>,initializer):
...
// (6.7.9)
rule(<InitAst.InitializerList>,initializer-list):
...
// (6.7.9)
rule(<InitAst.Designator>,designation,opt):
...
designator-list:
  ...
  ;
*/
rule(<InitAst.Designator>,designator-list):
    designator
  | designator designator-list[list]          { $$ = $designator.cons($list); }
  ;

// (6.7.9)
rule(<InitAst.Designator>,designator):
